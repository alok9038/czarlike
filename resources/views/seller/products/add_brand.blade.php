        ...
        <div class="card border-0 rounded-10 card-shadow">
            ...
            <div class="card-body">
                <div class="col-8 mx-auto">
                    <form action="{{ route('seller.brand.create') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="brand_name" class="fw-bold">Brand Name</label>
                            <input type="text" name="brand_name" id="brand_name" class="form-control shadow-none">
                            @error('brand_name')
                                <p class="small text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-3">
                            <label for="brand_logo" class="fw-bold">Brand Logo</label>
                        ...
                        {{-- <div class="mb-3">
                            ...
                            <label class="switch">
                                <input type="checkbox" value="1" name="is_verified">
