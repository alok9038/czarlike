...
@section('title',' Drivers Manager | Seller')
                        ...
                        <tbody>
                            @foreach ($drivers as $driver)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('seller.driver.active.deactive') }}" method="post">
                                            @csrf
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <form action="{{ route('seller.delete.driver') }}" method="POST">
                                                @csrf
