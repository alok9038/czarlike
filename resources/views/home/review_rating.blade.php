    ...
    <div class="container-fluid my-4">
        <div class="top-box d-flex bg-white p-3 shadow-sm">
            ...
            <div class="ms-auto d-flex">
                <img src="{{ asset('images/products/'.$product->image) }}" style="height: 38px; width:38px" alt="{{ $product->image }}" class="img-fluid bg-dark round-10">
                        ...
                        <div class="card border-0 shadow-sm rounded-0">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="" cols="30" rows="7" class="form-control shadow-none rounded-0" placeholder="  Description..">{{ $rating->body }}</textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label>Images</label>
                                    <input type="file" name="review_image[]" multiple placeholder="  Review title..." class="form-control rounded-0 shadow-none">
                                </div>
                                <div class="mb-3">
