    ...
    <div class="container my-4">
        <div class="card border-0 rounded-10 card-shadow">
            <div class="card-header border-0 pt-3 bg-transparent d-flex">
                <h4 class="card-title">Refund, Return and Cancellation</h4>
            ...
            <div class="card-body">
                <div class="col-12 mx-auto">
                    <form action="{{ route('super.admin.store.rrc') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="mb-3">
