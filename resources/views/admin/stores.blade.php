...
@section('title','Stores Manager | Admin')
        ...
        <div class="card border-0 rounded-10 card-shadow">
            <div class="card-header border-0 pt-3 bg-transparent d-flex">
                ...
                <span class="ms-auto"><a href="
                    {{ route('super.admin.create.store.view') }}
                    ...
                    <table id="example2" class="table table-hover table-borderless" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <form action="{{ route('super.admin.drop.store') }}" method="POST">
                                            @csrf
                                        ...
                                        <a href="{{ route('super.admin.update.store.view','store_id='.$store->id) }}" class="btn btn-info btn-sm"><i class="bx bx-edit"></i></a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
