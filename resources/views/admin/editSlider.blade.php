    ...
    <div class="container my-4">
        <div class="card border-0 rounded-10 card-shadow">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        <form action="{{ route('super.admin.update.slider') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3" style="{{ ($slider->linked_by != 'url')?'display: none':'' }}" id="url_div">
                                <label for="url" class="fw-bold">Enter Url : </label>
                                <input type="url" value="{{ $slider->url }}" placeholder=" http://" name="url" id="url" class="form-control shadow-none">
                            </div>
                            <div id="category_div" style="{{ ($slider->linked_by == 'category')?'':'display: none' }}">
                                <div class="mb-3">
                            ...
                            <div class="mb-3" id="product_div" style="{{ ($slider->linked_by != 'product')?'display: none':'' }}">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input type="text" name="heading" value="{{ $slider->heading_text }}" id="heading" class="form-control shadow-none">
                                </div>
                                <div class="col">
                                    <label for="heading_color" class="fw-bold">Text Color</label>
                                    <input type="color" name="heading_color" value="{{ $slider->heading_color }}" id="heading_color" class="form-control shadow-none">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="subheading" class="fw-bold">Slider Sub Heading</label>
                                    <input type="text" name="subheading" value="{{ $slider->subheading_text }}" id="subheading" class="form-control shadow-none">
                                </div>
                                <div class="col">
                                    <label for="sub_heading_color" class="fw-bold">Text Color</label>
                                    <input type="color" value="{{ $slider->sub_heading_color }}" name="sub_heading_color" id="sub_heading_color" class="form-control shadow-none">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col">
                                    <label for="button_text" class="fw-bold">Button Text</label>
                                    <input type="text" name="button_text" value="{{ $slider->button_text }}" id="button_text" placeholder=" Enter Button text" class="form-control shadow-none">
                                </div>
                                <div class="col-lg-3">
                                    <label for="button_text_color" class="fw-bold">Button Text Color</label>
                                    <input type="color" value="{{ $slider->button_text_color }}" name="button_text_color" id="button_text_color" class="form-control shadow-none">
                                </div>
                                <div class="col-lg-3">
                                    <label for="button_bg_color" class="fw-bold">Button Bg Color</label>
                                    <input type="color" value="{{ $slider->button_bg_color }}" name="button_bg_color" id="button_bg_color" class="form-control shadow-none">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="status" class="fw-bold">Status</label>
                                <label class="switch">
                                    <input type="checkbox"  {{ ($slider->status == 'active')?'checked':'' }} value="active" name="status">
                                    <span class="slider"></span>
                                </label>
                            </div>
                            <div class="mb-3">
                                <button class="btn btn-dark btn-sm float-end">Update slider</button>
                            </div>
                        </form>
                    </div>
                    <div class="col-lg-5">
                        ...
                        <div class="card-shadow" style="height: 250px; width:100%;">
                            <img src="{{ asset('images/slider/'.$slider->image) }}" alt="no-image" id="blah" style="height: 250px; width:100%;" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
