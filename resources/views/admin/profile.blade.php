    ...
    <div class="row">
        <div class="card mt-4 p-0 border-0 rounded-10 cws-shadow bg-white pt-5">
            <div class="col-lg-3  col-10 mx-auto">
                <div>
                    <div class="gallery-item">
                        <img class="gallery-image" src="{{ asset('users/images/'.Auth()->user()->image) }}" class="img-fluid" alt="" style="height: 293px;">
                    </div>
            ...
            <div class="card-body text-center">
                <h6 class="h5">{{ Auth()->user()->user_name }}</h6>
            ...
            <form action="{{ route('update.details') }}" method="POST">
                ...
                <div class="row">
                    <div class="mb-3 col">
                        ...
                        <input type="text" name="name" value="{{ Auth()->user()->user_name }}" class="form-control shadow-none">
                    </div>
                </div>
                {{-- <div class="row">
                    <div class="mb-3 col">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col">
                        ...
                        <input type="phone" name="phone" value="{{ Auth()->user()->phone }}" class="form-control shadow-none">
                    </div>
                </div>
                <div class="mb-3">
    ...
    <div class="modal-dialog">
      <div class="modal-content rounded-10">
        ...
        <div class="modal-body">
            <img src="{{ asset('users/images/'.Auth::user()->image) }}" class="img-fluid rounded-10 w-100 blah" id="blah" style="height: 300px; width:300px;object-fit:cover;" alt="">
