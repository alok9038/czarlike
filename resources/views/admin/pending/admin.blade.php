        ...
        <div class="card border-0 rounded-10 card-shadow">
            <div class="card-header border-0 pt-3 bg-transparent d-flex">
                ...
                {{-- <div class="search ms-auto">
                    <input type="search" placeholder=" search customers" class="form-control rounded-10">
                </div> --}}
                ...
                <div class="table-responsive pt-2 px-2">
                    <table id="example2" class="table table-striped table-borderless" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $admin->id }}</td>
                                <td><img src="{{ asset('users/images/'.$admin->image) }}" class="rounded-10" style="height: 40px; width:40px;" alt=""></td>
