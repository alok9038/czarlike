        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item" href="{{ route('super.admin.profile') }}"><i class="bx bx-user"></i><span>Profile</span></a>
                    </li>
                    <li><a class="dropdown-item" href="{{ route('super.admin.update.paytm.settings') }}"><i class="bx bx-cog"></i><span>Settings</span></a>
                    </li>
                    <li><a class="dropdown-item" href="{{ route("super.admin.dashboard") }}"><i class='bx bx-home-circle'></i><span>Dashboard</span></a>
                    </li>
                    @else
                    ...
                    <li>
                        ...
                        <a class="dropdown-item" href="#" onclick="javascript:$('#logout_form').submit();"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
                    </li>
                </ul>
            </div>
        </nav>
